...
typedef void (*bmp280_sensor_lock_i2c_callback_t) ();
...
{
    bmp280_sensor_lock_i2c_callback_t lock_i2c_callback;
    bmp280_sensor_lock_i2c_callback_t unlock_i2c_callback;
