...
typedef int (*bmp280_sensor_i2c_callback_t) (uint8_t device_address, uint8_t register_address, uint8_t *array, uint32_t array_size, uint32_t timeout_ms, std_error_t * const error);
